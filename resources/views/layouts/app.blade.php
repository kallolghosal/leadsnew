        ...
        $(document).ready(function() {
            $("#exprt").on('click', function () {
                ...
                if (strt === '' || endt === '' || strt >= endt) {
                    ...
                    } else if (token == 'markt' || owner == 'markt') {
                        window.location.href = '/mrkt-csv/'+strt+'/'+endt;
                    } else {
            ...
            $("#rmlead").on('click', function () {
                ...
                if (strt === '' || endt === '' || strt >= endt) {
                    ...
                    } else if (token == 'wv' || owner == 'wv') {
                        window.location.href = '/removewv/'+strt+'/'+endt;
                    } else {
                        window.location.href = '/removemrkt/'+strt+'/'+endt;
                    }
                }
            });
        });
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('export-leads') }}">Export</a></li>
