...
<div class="container">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="owner" id="markt" value="markt">
                <label class="form-check-label" for="markt">
                    WV Market
                </label>
            </div>
            <br /><br />
            ...
            <div class="input-group ms-auto">
                ...
                <button type="button" class="btn btn-success" id="rmlead" onclick="confirmDelete();">Remove Leads</button>
            </div>
            @if(session('status'))
